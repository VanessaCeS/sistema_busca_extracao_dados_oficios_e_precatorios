...
import xmltodict
import traceback
from esaj_sao_paulo import get_docs_oficio_precatorios_tjsp 
from funcoes_arteria import enviar_valores_oficio_arteria
from utils import encontrar_data_expedicao_e_cidade, encontrar_indice_linha, extrair_processo_origem, limpar_dados, regex, tipo_precatorio
...
def ler_xml(arquivo_xml):     
  ...
  for d in dados:
      # if d['processo'] == '0019951-88.2018.8.26.0053':
...
ler_xml('./arquivos_xml/relatorio_05_09.xml')
