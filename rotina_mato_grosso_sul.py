...
from utils import apagar_arquivos_txt, encontrar_indice_linha, limpar_dados, mandar_dados_regex, tipo_precatorio, verificar_tribunal
...
def ler_xml():     
  ...
  for d in dados:
        ...
        if verificar_tribunal(d['processo']):
          ...
          pass
  apagar_arquivos_txt(['arquivos_pdf_mato_grosso_do_sul', 'arquivos_txt_mato_grosso_sul', 'fotos_oab', 'pdf_oab'])
